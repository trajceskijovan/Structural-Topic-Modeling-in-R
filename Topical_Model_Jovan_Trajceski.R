...
# HomeWork 3: Structural Topic Modeling 
# Jovan Trajceski
# Student number: 20451571
# -----------------------------------------------------------------
...
setwd("C:/Users/Jovan Trajceski/OneDrive - Hong Kong Baptist University/Semester 2/ECON7930 Analytics for Spatial, Textual and Social/______________final/LDA")
...
# randomly sample 1000 rows as my laptop cant handle more
...
# Wordcloud:topic 15 with word distribution
set.seed(837)
cloud(Third_STM, topic=10, scale=c(4,.1))
